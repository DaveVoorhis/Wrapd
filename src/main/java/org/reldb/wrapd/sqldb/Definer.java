...
public class Definer {
    ...
    /**
     <p>Given the filespec of a YAML query definition file, run it to define queries.</p>

     <p>The file actually specifies a series of method invocations of methods defined
     in the Definer class.</p>
     ...
     <p>If the query defines parameters, test arguments must be provided. Then they are the
     second array element, which is itself an array. For the above query, the test argument array is
     [2, 5]. Since the arguments are positional corresponding to the appearance of the parameter
