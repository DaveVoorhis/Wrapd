...
public class TupleTypeGenerator {
    ...
    /** If this Tuple type maps to a table, we can set its name here and additional insert() and insert(Connection)
     * methods will be generated by generate() to simplify inserting into the table.
     *
    ...
    private String getTableInsertImports() {
        if (tableName == null)
            return "";
        return
            "import java.sql.*;" +
    ...
    private String getTableInsertDefs() {
        if (tableName == null)
            return "";
        return
            "\n\t/** " +
