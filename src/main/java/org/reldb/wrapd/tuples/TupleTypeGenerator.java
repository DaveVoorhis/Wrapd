...
public class TupleTypeGenerator {
    ...
    /**
     * If this Tuple type maps to a table, we can set its name here and
     * additional insert(), insert(Connection), update(), and update(Connection)
    ...
    private String getTableImports() {
        if (tableName == null)
            return "";
        return
            "import java.sql.*;" +
