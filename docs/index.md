...
5. SELECT queries generate Streams-friendly results. Java integration is easy and straightforward and practically eliminates the classic object-relational impedance mismatch.
