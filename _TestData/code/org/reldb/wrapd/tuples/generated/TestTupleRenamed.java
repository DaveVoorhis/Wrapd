...
/** TestTupleRenamed tuple class version 0 */
public class TestTupleRenamed implements Tuple {
	/** Version number */
	...
	public String toString() {
		return String.format("TestTupleRenamed {Col1 = %s, Col2 = %s, Col3 = %s, Col5 = %s}", this.Col1, this.Col2, this.Col3, this.Col5);
	}
}